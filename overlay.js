...
const caseStudy = [
  ...
  { name:'Minimalist e-Commerce', description:`
    <i><b>NOTE:</b></i><br>
    Version 2 of the backend of this project is currently at development. However, you can view its progress by clicking the repository link below.
    <br><br>
    <b>Frontend:</b> HTML, TailwindCSS, JavaScript, React, Ant Design
    <br><b>Backend:</b> C#, .NET Core 8, Web API, Entity Framework Core
    <br><b>Database:</b> MS SQL, Entity Framework Core
    <br><b>Others:</b> CQRS, MediatR, Domain-Driven Design, Fluent Validation, JWT Authentication
    <br><b>Gitlab:</b> <a href="https://gitlab.com/jerome5330510/server" target="_blank">Check the code here!</a>`
